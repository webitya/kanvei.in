      ...
      <AdminLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatsCard title="Total Products" value={stats.totalProducts} icon="📦" color="#5A0117" />
            <StatsCard title="Categories" value={stats.totalCategories} icon="📁" color="#8C6141" />
            <StatsCard title="Orders" value={stats.totalOrders} icon="🛒" color="#5A0117" />
            <StatsCard title="Users" value={stats.totalUsers} icon="👥" color="#8C6141" />
          </div>
