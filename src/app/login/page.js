...
export default function LoginPage() {
  ...
  const { login, loginWithOTP, loginWithGoogle, loginWithFacebook, sendOTP, loading } = useAuth()
  ...
  const handleGoogleLogin = async () => {
    ...
    setError("Google login integration requires Google OAuth SDK setup")
  }

  const handleFacebookLogin = async () => {
    // In a real app, you'd use Facebook SDK
    // For demo purposes, this is a placeholder
    setError("Facebook login integration requires Facebook SDK setup")
  }
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button
                  ...
                  className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors"
                  style={{ fontFamily: "Montserrat, sans-serif" }}
                >
