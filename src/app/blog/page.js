    ...
    <Link href={`/blog/${blog.slug}`} className="group">
      <article className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="p-6">
          ...
          {/* Description */}
          <p className="text-gray-600 mb-4 line-clamp-3" style={{ fontFamily: "Montserrat, sans-serif" }}>
            {blog.description}
          </p>
          ...
          <div className="flex items-center justify-between text-sm text-gray-500">
            <div className="flex items-center gap-4">
              {blog.author && <span style={{ fontFamily: "Montserrat, sans-serif" }}>By {blog.author}</span>}
              {blog.readTime && <span style={{ fontFamily: "Montserrat, sans-serif" }}>{blog.readTime} min read</span>}
            </div>
